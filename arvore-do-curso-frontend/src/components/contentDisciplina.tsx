...
import { ExcluirDisciplina } from "./excluirDisciplina"
...
export function ContentDisciplina(props: ContentProps) {
    ...
    return (
        <div className={styles.container}>
            ...
            {editarCurso ? <EditDisciplina /> : <></>}

            {excluirCurso ? <ExcluirDisciplina /> : <></>}

            {cadastrarCurso ? <CadastrarDisciplina /> : <></>}
        </div>
    )
}
